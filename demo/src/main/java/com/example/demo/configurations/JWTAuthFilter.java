...
import com.example.demo.services.UserCustomService;
...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        usename = jwtUtils.extractUsername(jwtToken);
        if (usename != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            UserDetails userDetails = userCustomService.loadUserByUsername(usename);
